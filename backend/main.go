...
func main() {
	...
	if repo != nil {
		...
		api.HandleFunc("/v1/students/deleted", requireAuth(studentHandler.ListDeleted)).Methods("GET")
		...
		api.HandleFunc("/v1/students/{id}/restore", requireAuth(studentHandler.Restore)).Methods("POST")
		api.HandleFunc("/v1/students/{id}/permanent", requireAuth(studentHandler.HardDelete)).Methods("DELETE")
		...
		api.HandleFunc("/v1/subjects/deleted", requireAuth(subjectHandler.ListDeleted)).Methods("GET")
		...
		api.HandleFunc("/v1/subjects/{id}/restore", requireAuth(subjectHandler.Restore)).Methods("POST")
		api.HandleFunc("/v1/subjects/{id}/permanent", requireAuth(subjectHandler.HardDelete)).Methods("DELETE")
